  ...
  return (
    <div className="bg-white font-sans text-gray-800 antialiased overflow-x-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            >
              <h1 className="text-xl font-black text-gray-900">BRSA</h1>
              <p className="text-[6px] text-gray-500 -mt-1 tracking-wider">
          ...
          {/* Mobile Menu - PURE WHITE BACKGROUND */}
          {isMenuOpen && (
      ...
      <main className="pt-16">
        {/* Hero Section */}
        <section id="home" className="min-h-screen flex items-center bg-gradient-to-br from-gray-50 to-white px-4 py-8">
          <div className="max-w-7xl mx-auto w-full">
            <div className="grid lg:grid-cols-2 gap-6 items-center">
              <div className="space-y-4">
                <div className="inline-flex items-center space-x-2 bg-orange-100 px-3 py-1.5 rounded-full">
                  <FiAward className="text-orange-600 w-3.5 h-3.5" />
                  <span className="text-orange-600 text-[10px] font-semibold">Premier Shooting Academy</span>
                </div>
                ...
                <p className="text-xs text-gray-500 italic border-l-4 border-orange-600 pl-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    onClick={() => scrollToSection('contact')}
                    className="px-4 py-2.5 bg-gradient-to-r from-orange-600 to-orange-500 text-white text-xs font-semibold rounded-full active:scale-95 transition-all duration-200 flex items-center space-x-1"
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-gray-900 text-black text-xs font-semibold rounded-full active:scale-95 transition-all duration-200"
                  >
                    View Gallery
                  </button>
                </div>
        ...
        {/* About Section */}
        <section id="about" className="py-12 bg-gray-50 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-black mb-2 text-gray-900">About BRSA</h2>
              <div className="w-12 h-1 bg-gradient-to-r from-orange-600 to-orange-400 mx-auto rounded-full"></div>
            </div>
        ...
        {/* The Sport Section */}
        <section id="sport" className="py-12 bg-white px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-black mb-2 text-gray-900">The Sport</h2>
              <div className="w-12 h-1 bg-gradient-to-r from-orange-600 to-orange-400 mx-auto rounded-full mb-3"></div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                return (
                  <div key={index} className="bg-gray-50 p-2.5 rounded-lg text-center">
                    ...
                    <h4 className="text-[9px] font-bold text-gray-900">{benefit.title}</h4>
                  </div>
                );
              })}
            </div>
        ...
        {/* Facilities Section */}
        <section id="facilities" className="py-12 bg-gray-50 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-black mb-2 text-gray-900">Facilities</h2>
              <div className="w-12 h-1 bg-gradient-to-r from-orange-600 to-orange-400 mx-auto rounded-full"></div>
            </div>
                ...
                return (
                  <div key={index} className="bg-white p-3 rounded-lg shadow-sm">
                    <div className="flex items-center space-x-3">
                      ...
                      <h3 className="font-bold text-xs text-gray-900">{facility.title}</h3>
                    </div>
                  </div>
                );
              })}
        ...
        {/* Coaching Section */}
        <section id="coaching" className="py-12 bg-white px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-black mb-2 text-gray-900">Coaching</h2>
              <div className="w-12 h-1 bg-gradient-to-r from-orange-600 to-orange-400 mx-auto rounded-full"></div>
            </div>

            <div className="space-y-3">
              <div className="bg-gradient-to-br from-gray-50 to-white p-4 rounded-lg shadow-sm">
                <h3 className="text-sm font-bold mb-2 text-gray-900">Training Programs</h3>
                <div className="space-y-1.5">
                  {[
                    ...
                    <div key={index} className="flex items-center space-x-2">
                      <FiChevronRight className="w-3 h-3 text-orange-600" />
              ...
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-4 rounded-lg text-white">
                <h3 className="text-sm font-bold mb-2">Why Choose BRSA</h3>
                <p className="text-xs text-gray-300 mb-2">
                  Experienced coaches and personalized attention for all skill levels.
                </p>
                <div className="bg-orange-600/20 p-3 rounded-lg">
                  <h4 className="font-bold text-xs mb-0.5">Trial Sessions</h4>
                  <p className="text-[9px] text-orange-200">Available for beginners</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Gallery Section */}
        <section id="gallery" className="py-12 bg-gray-50 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-black mb-2 text-gray-900">Gallery</h2>
              <div className="w-12 h-1 bg-gradient-to-r from-orange-600 to-orange-400 mx-auto rounded-full mb-2"></div>
              <p className="text-xs text-gray-600">Moments at BRSA</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {displayedImages.map((image) => (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-end p-1">
                    <p className="text-white text-[8px] font-semibold truncate">{image.title}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center space-x-3 mt-4">
                <button
                  ...
                  className="p-1.5 rounded-full bg-white border disabled:opacity-50 active:bg-orange-50 transition-colors"
                >
        ...
        {selectedImage && (
          <div
            className="fixed inset-0 z-[60] flex items-center justify-center p-2 bg-black/90"
          ...
          >
            <div className="relative max-w-3xl w-full">
              ...
              <button
                onClick={() => setSelectedImage(null)}
                className="absolute top-1 right-1 p-1.5 bg-black/50 rounded-full"
              >
                <FiX className="w-3.5 h-3.5 text-white" />
              </button>
              <div className="absolute bottom-1 left-1 right-1 bg-black/50 p-2 rounded-lg">
                <h3 className="text-white text-xs font-bold">{selectedImage.title}</h3>
                <p className="text-orange-400 text-[8px]">{selectedImage.category}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <section id="contact" className="py-12 bg-white px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-black mb-2 text-gray-900">Contact</h2>
              <div className="w-12 h-1 bg-gradient-to-r from-orange-600 to-orange-400 mx-auto rounded-full"></div>
            </div>

            <div className="bg-gradient-to-br from-gray-50 to-white p-5 rounded-lg shadow-sm">
              <div className="text-center">
                <FiMapPin className="w-6 h-6 text-orange-600 mx-auto mb-2" />
                
                <h3 className="text-sm font-bold mb-2">Bangalore Rifle Shooters Arena</h3>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-center space-x-2">
                      ...
                      <a href="tel:919739565677" className="text-sm font-bold text-orange-600">
                        +91 97395 65677
                      </a>
                    </div>
                    <div className="flex items-center justify-center space-x-2">
                      <FiMail className="w-3.5 h-3.5 text-orange-600" />
                      <a href="mailto:info@brsa.in" className="text-xs text-gray-600">
                        info@brsa.in
                      </a>
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  <a
                    ...
                    className="py-2.5 bg-gradient-to-r from-orange-600 to-orange-500 text-white text-xs font-semibold rounded-lg active:scale-95 transition-all flex items-center justify-center space-x-2"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    className="py-2.5 bg-gray-900 text-white text-xs font-semibold rounded-lg active:scale-95 transition-all flex items-center justify-center space-x-2"
                  >
            ...
            <div className="mt-3 text-center text-[9px] text-gray-500">
              ...
              <p className="mt-0.5">Sunday by appointment</p>
            </div>
          </div>
        </section>
      </main>
      ...
      <footer className="bg-gray-900 text-white py-6 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-3">
            <h3 className="text-base font-bold mb-1">BRSA</h3>
          ...
          <div className="flex justify-center space-x-3 mb-3">
            {[FiTarget, FiUsers, FiAward].map((Icon, index) => (
              <div key={index} className="w-6 h-6 bg-gray-800 rounded-full flex items-center justify-center hover:bg-orange-600 transition-colors cursor-pointer">
                <Icon className="w-3 h-3 text-gray-400 hover:text-white" />
              </div>
            ))}
          </div>
          
          <div className="text-center text-[8px] text-gray-500 pt-3 border-t border-gray-800">
            <p>© 2024 Bangalore Rifle Shooters Arena. All rights reserved.</p>
            <p className="mt-0.5">Affiliated to Karnataka State Rifle Association</p>
          </div>
        </div>
      </footer>
    </div>
